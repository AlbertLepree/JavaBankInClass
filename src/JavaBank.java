...
public class JavaBank extends JFrame {
  ...
  // method that displays individual account details
  ...
  private void createUserInterface() {
    ...
    inputDetailJPanel
        .setBackground(myColor); // sets the color of the background based on the colors provided
  ...
  private void DisplayJButtonActionPerformed(ActionEvent event) {
    ...
    if (noAccounts == 0) {
      ...
      for (int i = 0; i < noAccounts; i++) {
        ...
        displayJTextArea.append("Bank Name: " + myAccounts[i].getBankName() + "\n" +
